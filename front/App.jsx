...
import QuestionMainPage from './pages/QuestionMainPage.jsx';
import QuestionViewPage from './pages/QuestionViewPage.jsx';
import InsertQuestion from './Question/InsertQuestion.jsx';
import 'bootstrap/dist/css/bootstrap.css';
import UpdateQuestion from './Question/UpdateQuestion.jsx';
import { CheckoutPage } from './Checkout/Checkout.jsx';
import { SuccessPage } from './Checkout/Success.jsx';
import { FailPage } from './Checkout/Fail.jsx';
...
const router = createBrowserRouter([
  ...
  { path: '/ledger/calendar', element: <CalendarPage />},
    ...
    // 1:1문의
    { path: '/QuestionView/:questionId', element:<QuestionViewPage />}, 
    { path: '/insertquestion', element:<InsertQuestion />},
    { path: '/QuestionMainPage', element: <QuestionMainPage />},
    { path: '/updateQuestion/:questionId', element: <UpdateQuestion />},
