...
export default function SpendingDaily() {
  ...
  const modalContent = (
    <div>
      <form className="m-4">
        <h2 className="m-12 text-center text-2xl font-semibold">지출 입력</h2>
      <div className="m-2">
        <label>지출일</label>
        <input
          className="w-60"
...
// 수정 폼
  ...
  return (
    <>
      <div>
        <ReactModal className="m-auto translate-y-40 flex flex-col w-2/6 items-center rounded bg-green-300"
        isOpen={modifyIsOpen}
        >
          {modifyContent}
          <div>
        <button className="m-8 w-16 h-12 rounded bg-green-500 text-white" onClick={modifySubmit}> 확인 </button>
        <button className="m-8 w-16 h-12 rounded bg-green-500 text-red-600" onClick={()=>setModifyIsOpen(false)}> 닫기 </button>
        </div>
      ...
      <div>
        ...
        >
          {modalContent}
          <div>
        <button className="m-8 w-16 h-12 rounded bg-green-500 text-white" onClick={spendingSubmit}> 확인 </button>
        <button className="m-8 w-16 h-12 rounded bg-green-500 text-red-600" onClick={()=>setIsOpen(false)}> 닫기 </button>
        </div>
